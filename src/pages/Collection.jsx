...
const Collection = () => {
  ...
  return (
    <section className='bg-gradient-to-b from-red-50 via-white to-white max-padd-container'>
      <div className='flex flex-col sm:flex-row gap-8 mt-8 xl:mt-6'>
        {/* Filter-Option */}
        <div className='min-w-60 bg-bg-gradient-to-b from-red-50 via-white to-white p-4 rounded-2xl'>
          {/* Search-Box */}
           <ShowSearch/>
          {/* Catagorie-Filter */}
           <div className='bg-gradient-to-b from-red-50 via-white to-white ring-1 ring-slate-900/5 pl-5 py-3 mt-6 rounded-xl'>
            <h5 className='h5 mb-4'>Gender</h5>
           ...
           {/* Type-Filter */}
           <div className='bg-bg-gradient-to-b from-red-50 via-white to-white ring-1 ring-slate-900/5 pl-5 py-3 mt-6 rounded-xl'>
           <h5 className='h5 mb-4'>Blood Groups</h5>
            <div className='flex flex-col gap-2 text-sm font-light'>
              {["O+" , "O-" , "A+" , "A-" , "B+" , "B-" , "AB+"].map((subCat)=> (
        ...
        {/* Right-Side */}
          <div className='bg-gradient-to-b from-red-50 via-white to-white p-4 rounded-2xl'>
            <Title title={'Blood Donor'}/>
            {/* Product-Container */}
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 gap-y-6'>
              {filteredProducts.length > 0 ? (
                ...
                <p className='capitalize'>No Donor Found.</p>
              )}
            </div>
          </div>
      </div>
